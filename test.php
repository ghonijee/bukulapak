...
<body>
   ...
   <div class="container" style="margin-top:7rem;">
      <h4 class="text-info badge-light p-3">Pesananku</h4>
      <div class="row">
         <div class="col-8">
                  ...
                  <div class="row mt-3 mb-2">
                     ...
                     <div class="col-4">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                           ...
                           <span class="custom-file-label w-75 ml-3">Foto..</span><input type="file" class="custom-file-input mb-2"
                              name="konfirmasi">
                           <button class="btn-info w-75 mb-1 border-0 pt-2 pb-2 rounded" name="konfirmasi" type="submit">Konfirmasi</button>
                           <a href="detail_pesanan.php?kd_order=<?php echo $hasil['kd_order']; ?>" class="text-center btn-block border pb-2 rounded"
         ...
         <div class="col-12">
            <div class="row justify-content-center">
               <div class="col-5 rounded text-center text-info p-3">
                  ...
                  <div class="mt-3">
                     <a href="home.php" class="mt-5 rounded btn-info pt-2 pb-2 pr-5 pl-5 btn-lg text-center text-light" style="text-decoration: none;">Belanja Yuk!</a>
                  </div>
               </div>
            </div>
         </div>
