...
<?php require_once 'template/navbar.php'; ?>
   <div class="container" style="margin-top:7rem;">
      <h4 class="text-info text-left badge-light p-3 mb-4">Keranjang Anda</h4>
      <div class="row">
         <div class="col-8">
               ...
               <div class="col-12">
                  <div class="row border-top p-3 mb-3">
                    ...
                    <div class="col-2 d-none d-md-inline text-right">
                        ...
                        <a href="#" class="text-danger font-weight-bold" data-toggle="modal" data-target="#hapus">Hapus</a>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content rounded border-0">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="hapus_pesan.php?id=<?php echo $kode; ?>" class="btn btn-danger text-light font-weight-bold">Hapus</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row border badge-light p-3 rounded w-100 ">
                        ...
                        <div class="col-12 text-center">
                            <form action="" method="POST">
                                ...
                                <button type="button" class="btn-block border-0 btn-info p-2 rounded" name="checkout" data-toggle="modal" data-target="#checkout">Checkout</button>
                                <div class="modal fade" id="checkout" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content rounded border-0">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                <button type="submit" class="btn border-0 btn-info p-2 rounded" name="checkout">Checkout</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
      ...
      <?php
         ...
         <div class="col-12">
            <div class="row justify-content-center">
               <div class="col-5 rounded text-center text-info">
