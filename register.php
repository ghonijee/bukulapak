        ...
        ?>
            <div class="row">
                <div class="col-4 offset-1">
                    <h4 class="text-info text-center font-weight-bold mb-4 badge-light p-2 rounded">Login Disini!</h2>
                </div>
                <div class="col-5 offset-1">
                    <h4 class="text-info text-center font-weight-bold mb-4 badge-light p-2 rounded">Daftar Disini!</h2>
                </div>
            </div>
            <div class="row">
            <div class="col-4 offset-1 border-right rounded p-4 mb-5">
                <form action="" method="post">
                        ...
                        <button type="submit" name='login' class="btn-info border-0 pr-4 pl-4 pt-2 pb-2">Login</button>
                    </form>
            </div>
                <div class="col-5 offset-1 border-left rounded p-4 mb-5">
                    <form method="POST" action="" onsubmit="return validasi()" name="register">
                        ...
                        <button type="submit" name="register" class="btn-info border-0 pr-4 pl-4 pt-2 pb-2">Daftar</button>
                        <button type="reset" class="btn-info border-0 pr-4 pl-4 pt-2 pb-2">Reset</button>
                    </form>
                </div>
            </div>
        </div>
